...
describe('migrations', () => {
  ...
  it('upgrades a database created by sync and merges duplicate direct chats', async () => {
    ...
    const insertChat = (id: string, creator: string, participants: string[], createdAt: string) =>
      sequelize.query(
    ...
    const insertMessage = (chatId: string, sender: string, content: string, createdAt: string) =>
      sequelize.query(
